...
def create_report(patient_name, interp_date, study_date, patient_code, interp_dr, sex, dob, height, weight, bmi, diagnosis):
    pdf = FPDF()
    ...
    pdf.cell(w=0, h=4, txt='HOME SLEEP TEST ANALYSIS REPORT', align='L')
...
if __name__ == '__main__':
    create_report(patient_name='Dahab Shakeel', interp_date='9/3/2019', study_date='8/26/2019', patient_code='TS082619',
                  interp_dr='Chandra Matadeen-Ali, MD', sex='M', dob='10/23/1998', height=186, weight=75, bmi='', diagnosis='Severe Obstructive Sleep Apnea (G47.33)')
